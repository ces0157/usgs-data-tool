...
def download_data(args, download_information: dict, output_dir:str):
    ...
    if args.type == "dem" and (args.dem_merge == "merge-keep" or args.dem_merge == "merge-delete"):
        if args.dem_merge == "merge-keep":
            merge_dem(project_dirs, True, args.dem_output, args.dem_merge_method, args.png_precision)
        else:
            merge_dem(project_dirs, False, args.dem_output, args.dem_merge_method, args.png_precision)
